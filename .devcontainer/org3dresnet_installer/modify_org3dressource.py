...
if __name__ == "__main__":
    ###
    target_file = "org3dresnet/models/resnet.py"
    out = open("temp.py", "w")
    ...
    ###
    target_file = "org3dresnet/models/resnext.py"
    out = open("temp.py", "w")
    f = open(target_file, "r")
    lines = f.readlines()
    ...
    ###
    target_file = "org3dresnet/main.py"
    out = open("temp.py", "w")
    f = open(target_file, "r")
    lines = f.readlines()
    ...
    ###
    target_file = "org3dresnet/model.py"
    out = open("temp.py", "w")
    f = open(target_file, "r")
    lines = f.readlines()
    ...
    for i, line in enumerate(lines):
        if line == "from models import resnet, resnet2p1d, pre_act_resnet, wide_resnet, resnext, densenet\n":
            lines[i] = "from .models import resnet, resnet2p1d, pre_act_resnet, wide_resnet, resnext, densenet\n"
    ...
    ###
    target_file = "org3dresnet/dataset.py"
    out = open("temp.py", "w")
    f = open(target_file, "r")
    lines = f.readlines()
    ...
    ###
    target_file = "org3dresnet/training.py"
    out = open("temp.py", "w")
    f = open(target_file, "r")
    lines = f.readlines()
    ...
    ###
    target_file = "org3dresnet/validation.py"
    out = open("temp.py", "w")
    f = open(target_file, "r")
    lines = f.readlines()
    ...
    ###
    target_file = "org3dresnet/inference.py"
    out = open("temp.py", "w")
    f = open(target_file, "r")
    lines = f.readlines()
